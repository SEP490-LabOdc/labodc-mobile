...
class MyWalletPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Khởi tạo Cubit và load dữ liệu ví ngay khi vào trang
    return BlocProvider(
      ...
      body: BlocListener<WalletCubit, WalletState>(
        listener: (context, state) {
          if (state is WalletLoaded) {
            // Sau khi rút tiền, loadWallet được gọi lại và rơi vào state này
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Cập nhật trạng thái ví thành công!'),
        ...
        child: BlocBuilder<WalletCubit, WalletState>(
          builder: (context, state) {
            ...
            if (state is WalletLoaded) {
              ...
              final canWithdraw = wallet.balance > 0;
